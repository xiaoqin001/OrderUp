...
class Menu(db.Model):
    ...
    menuitems = db.relationship("MenuItem", back_populates="menu", cascade="all, delete-orphan")
...
class MenuItemType(db.Model):
    ...
    menuitems = db.relationship("MenuItem", back_populates="type", cascade="all, delete-orphan")
